                    ...
                    <!--     <li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" href="#collapseExample4" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fa fa-pencil-square-o fa-fw"></i><span class="menu-orders"> Orders <i class="fa fa-sort-down"></i></span>
                            </a>
                            <div class="collapse" id="collapseExample4">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                    <a class="nav-link" href="<?php echo web_root; ?>admin/orders?status=Pending"><i class="fa fa-tags" aria-hidden="true"></i>
                                     Pending Orders
                                    </a>
                                    </li>
                                    <li class="nav-item">
                                    <a class="nav-link" href="<?php echo web_root; ?>admin/orders?status=Confirmed"><i class="fa fa-tags" aria-hidden="true"></i>
                                     Confirmed Orders
                                    </a>
                                    </li>
                                    <li class="nav-item">
                                    <a class="nav-link" href="<?php echo web_root; ?>admin/orders?status=Delivered"><i class="fa fa-tags" aria-hidden="true"></i>
                                     Delivered Orders
                                    </a>
                                    </li>
                                    </ul>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" href="#collapseExample5" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fa fa-pencil-square-o fa-fw"></i><span class="menu-title"> Products <i class="fa fa-sort-down"></i></span>
                            </a>
                            <div class="collapse" id="collapseExample5">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                    <li>
                                        <a href="<?php echo web_root; ?>admin/products1/"><i class="fa fa-barcode fa-fw"></i>  Vegetables </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo web_root; ?>admin/products/"><i class="fa fa-barcode fa-fw"></i>  Fruits </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo web_root; ?>admin/category/" ><i class="fa fa-list-alt fa-fw"></i>  Categories: Fruits </a>
                                    </li> 
					                <li>
                                        <a href="<?php echo web_root; ?>admin/category1/" ><i class="fa fa-list-alt fa-fw"></i>  Categories: Vegetables </a>
                                    </li>
  				                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/supplier/" ><i class="fa fa-user fa-fw"></i>Suppliers</a>
                        </li>
                        <li class="nav-item">
