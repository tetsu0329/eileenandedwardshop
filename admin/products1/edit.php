                ...
                <div class="row"> 
                  ...
                  <div class="form-group">
                     <div class="col-md-8">
                       ...
                       <div class="col-md-8"> 
                       <textarea class="form-control input-sm" id="PRODNAME" name="PRODNAME" cols="1" rows="3" ><?php echo $singleproduct->PRODNAME; ?></textarea>
                       </div>
                     </div>
                   </div>
                  </div> 
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                          <input class="form-control input-sm" id="PROPRICE"  step="any" name="PROPRICE" placeholder=
                            "&#8369 Price " type="number" value="<?php echo $singleproduct->PROPRICE; ?>">
                      </div>
